...
ShowOverlay() {
    ...
    MyGui.Add("Text",, "═══════════════════════════════════════")
    MyGui.Add("Text",, "  Numpad1  → Чистка ПМ")
    MyGui.Add("Text",, "  Numpad2  → Представление")
    MyGui.Add("Text",, "  Numpad3  → Ксива")
    MyGui.Add("Text",, "  Numpad4  → Наручники / Обыск")
    MyGui.Add("Text",, "  Numpad5  → Рация")
    MyGui.Add("Text",, "  Numpad6  → Миранда")
    MyGui.Add("Text",, "  Numpad7  → Арест")
    MyGui.Add("Text",, "  Numpad8  → ПМ в боевое")
    MyGui.Add("Text",, "  Numpad9  → (свободно)")
    MyGui.Add("Text",, "  Numpad0  → (свободно)")
    MyGui.Add("Text",, "  Ctrl+Numpad4 → Настройки")
    MyGui.Add("Text",, "═══════════════════════════════════════")
